...
export const allUserReducer = (state = { user: [], loading: false, error: null }, action) => {
    switch (action.type) {
      ...
      case ALL_USER_LOAD_SUCCESS:
        return {
          ...state,
          loading: false,
          user: action.payload, // Assuming payload contains the user array directly
          error: null,
        };
