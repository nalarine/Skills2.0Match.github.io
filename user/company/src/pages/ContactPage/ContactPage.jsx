  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(
        'http://localhost:8800/api-v1/contacts',
        formData,
      )
  ...
  return (
    <>
      <div
        ...
        style={{
          background:
            "linear-gradient(rgba(33,33,33,0.522), rgba(33,33,33,0.522)) no-repeat, url('../../../src/assets/contact.png') center / cover",
          height: '100vh',
          zIndex: 2,
        }}
      />
      ...
      <div className="homeText text-center relative z-10">
        ...
        >
          We look forward to hearing from you and addressing your needs—stay
          connected with us!
        </p>
      </div>
      ...
      <div className="contact-container mt-64 grid grid-cols-2 grid-rows-1 gap-8 pt-12 px-12 rounded-lg shadow-md text-black">
        <div
          ...
          className="message-form row-span-3 p-5 bg-green-300 rounded-xl shadow-sm h-fit"
        >
          <h2 className="text-3xl font-bold mb-5 text-neutral-800">
            Contact Form
          </h2>
          <form onSubmit={handleSubmit}>
            <div className="form-field mb-5">
              <input
                ...
                className="w-full p-2.5 rounded-md border border-solid border-gray-400"
            ...
            <div className="form-field mb-5">
              <textarea
                name="message"
                placeholder="Message"
                className="w-full p-2.5 rounded-md border border-solid border-gray-400 h-36"
                onChange={handleChange}
              ></textarea>
            </div>
        ...
        <div className="contact-info-map">
          <div
            data-aos="fade-right"
            data-aos-duration="2500"
            className="contact-info p-5 bg-[#D0F0C0] rounded-lg shadow-sm"
          >
            ...
            <div className="info-item flex my-4 mx-0 text-neutral-800 items-center">
              <HiOutlineLocationMarker
                className="icon mr-0.5 align-middle min-w-7 h-7 text-green-500 flex justify-center items-center rounded-full mr-3.5"
                style={{ fontSize: 1 }}
              />
              <p className="items-center mr-3.5">
          ...
          <div
            ...
            className="map row-start-2 row-end-3 p-2.5 "
          >
            <iframe
              className="w-full h-80 mt-5 rounded-md"
              title="Google Map"
