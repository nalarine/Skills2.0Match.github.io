  ...
  return (
    <> 
      ...
      {/* CONTACT START --------------------------------------- */}
        ...
        <div className="contact-container mt-64 grid grid-cols-2 grid-rows-1 gap-8 pt-12 px-12 rounded-lg shadow-md text-white">
          <div data-aos="fade-up" data-aos-duration="2000" className="message-form row-span-3 p-5 bg-green-300 rounded-xl shadow-sm h-fit">
            ...
            <form action="">
              <div className="form-field mb-5">
                <input type="text" name="firstname" placeholder="First Name" className= "w-full p-2.5 rounded-md border border-solid border-gray-400" />
              </div>
              <div className="form-field mb-5">
                <input type="text" name="lastname" placeholder="Last Name" className= "w-full p-2.5 rounded-md border border-solid border-gray-400"/>
              </div>
              <div className="form-field mb-5">
                <input type="email" name="email" placeholder="Email Address" className= "w-full p-2.5 rounded-md border border-solid border-gray-400"/>
              </div>
              <div className="form-field mb-5">
                <input type="tel" name="Mobile/Telephone Number" placeholder="Mobile/Telephone Number" className= "w-full p-2.5 rounded-md border border-solid border-gray-400"/>
              </div>
              <div className="form-field mb-5">
                <textarea name="message" placeholder="Message" className= "w-full p-2.5 rounded-md border border-solid border-gray-400 h-36"></textarea>
              </div>
