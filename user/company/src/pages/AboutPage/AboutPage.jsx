...
const AboutPage = () => {
  ...
  return (
    <>
      {/* NAVBAR START */}
      <div className="absolute top-0 left-0 w-full h-full" style={{ background: "linear-gradient(rgba(33,33,33,0.522), rgba(33,33,33,0.522)) no-repeat, url('../../../src/assets/about.png') center / cover", height: '100vh', zIndex: 2 }} />
      ...
      {/* ABOUT US START */}
      <section className="flex justify-center items-center pt-64 pl-14 text-left mt-[30%] md:mt-[40%] lg:mt-80 xl:mt-[15%] p-6 md:p-12 xl:p-16 min-h-screen">
        <div data-aos="fade-right" data-aos-duration="2000" className="flex-1 w-full lg:w-1/2 mx-4">
          ...
          <p className="mb-3 text-gray-500 dark:text-gray-400 first-line:uppercase first-line:tracking-widest first-letter:text-7xl first-letter:font-bold first-letter:text-gray-900 dark:first-letter:text-gray-100 first-letter:me-3 first-letter:float-start">
            ...
            {isExpanded && (
              <>
                <br /><br />
                Our story is one of innovation, collaboration, and a shared vision to create a world where educational backgrounds don't define destiny. With the unwavering support of <strong className="font-semibold text-gray-900 dark:text-black">Technological Institute of the Philippines and the partnership of the United States Agency for International Development (USAID)</strong>, we've embarked on a mission to revolutionize the way OSY candidates access meaningful employment.
                <br /><br />
          ...
          <div className="flex justify-center lg:justify-start pr-16">
            <Button color="success" variant="ghost" onClick={toggleReadMore} className="text-black">
              {isExpanded ? 'Show less' : 'Show more'}
            </Button>
          </div>
        </div>
        <div data-aos="fade-left" data-aos-duration="2500" className="flex-1 w-full lg:w-1/2 mx-4">
          <div className="relative flex justify-center items-center h-96">
            <Image isBlurred width={350} height={350} src={logo} alt="" className="m-5" />
          </div>
        </div>
      </section>
      <div className="section w-full">
        <div className="cont1 w-full block mx-auto py-4 px-0">
          <div className="title w-full text-center mb-12">
            <h1 data-aos="fade-up" data-aos-duration="3000" className="text-5xl text-green-500 font-bold mb-24 mt-12">GUIDING PRINCIPLES</h1>
          </div>
        </div>
        <div className="wrapper">
          <div data-aos="fade-down" data-aos-duration="3500" className="team flex justify-center w-auto text-center flex-wrap">
            <div className="relative">
              <div className="absolute inset-0 flex items-center justify-center bg-slate-200 text-green-900 opacity-70 text-[13rem] z-0 font-bold pl-60">
                <span className="block transform -translate-y-1/2 ">MISSION</span>
              </div>
              <div className="flex items-center py-12">
                <div className="w-1/2">
                  <img src={mission} alt="Dashboard Icon" className="w-[220px] h-[220px] ml-8 relative z-10" />
                </div>
                <div className="w-1/2 z-10">
                  <p className="text-black-700 -ml-[385px] mr-[50px] pt-12 text-left">
            ...
            <div className="relative mt-40">
              <div className="absolute inset-0 flex items-center justify-center bg-slate-200 text-green-900 opacity-70 text-[13rem] z-0 font-bold pr-64 mb-12">
                <span className="block transform -translate-y-1/2">VISION</span>
              </div>
              <div className="flex items-center py-12">
                <div className="w-1/2 z-10">
                  <p className="text-black-700 -mr-[350px] ml-[100px] pt-12 text-right">
                ...
                <div className="w-1/2">
                  <img src={vision} alt="Dashboard Icon" className="w-[250px] h-[250px] ml-[400px] relative z-10" />
                </div>
              </div>
            </div>
          </div>
      ...
      <div className="footer bg-gray-200 pl-2 py-6 md:py-10 lg:py-12">
        <div className="secContainer container flex flex-col md:flex-row justify-between items-center md:items-start px-4 md:px-20 text-sm">
          <div data-aos="fade-up" data-aos-duration="2000" className="logoDiv flex flex-col items-center md:items-start">
            <div data-aos="fade-up" data-aos-duration="2000" className="footerLogo pb-2">
              <a href="#" className="logo">
                <img src={footerimg} className="cursor-pointer w-36 md:w-44" alt="Footer Logo" />
              </a>
            </div>
          ...
          <div data-aos="fade-up" data-aos-duration="4000" className="footerLinks flex flex-col items-center md:items-start">
          ...
          <div data-aos="fade-up" data-aos-duration="5000" className="footerLinks flex flex-col items-center md:items-start">
