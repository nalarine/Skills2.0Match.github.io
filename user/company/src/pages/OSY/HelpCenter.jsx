...
export default function JobPortalFAQs() {
  ...
  const handleSubmitFeedback = () => {
	...
	return (
				...
				<div className="accordion-column">
					<Accordion variant="splitted">
						<AccordionItem
							...
							className={`custom-accordion-item ${activeIndex === 1 ? "active" : ""
								}`}
						...
						>
							...
							<div className="custom-accordion-content font-normal">
								...
								partner with companies offering opportunities suitable for OSYs to
						...
						<AccordionItem
							...
							aria-label="What opportunities are available for OSYs on our job portal?"
							title="What opportunities are available for OSYs on your job portal?"
							className={`custom-accordion-item ${activeIndex === 2 ? "active" : ""
								}`}
						...
						<AccordionItem
							...
							aria-label="What opportunities are available for OSYs on our job portal?"
							title="What opportunities are available for OSYs on your job portal?"
							className={`custom-accordion-item ${activeIndex === 3 ? "active" : ""
								}`}
				...
				<div className="accordion-column">
					<Accordion variant="splitted">
						<AccordionItem
							...
							className={`custom-accordion-item ${activeIndex === 4 ? "active" : ""
								}`}
						...
						>
							...
							<div className="custom-accordion-content font-normal">
								...
								building assistance, interview preparation workshops, and access to
								career counseling sessions. Our goal is to empower OSYs and help
								them succeed in their job search and career development.
							</div>
						</AccordionItem>
						...
						<AccordionItem
							...
							aria-label="What support services are available for OSYs on your job portal?"
							title="What support services are available for OSYs on your job portal?"
							className={`custom-accordion-item ${activeIndex === 5 ? "active" : ""
								}`}
						...
						<AccordionItem
							...
							aria-label="What support services are available for OSYs on your job portal?"
							title="What support services are available for OSYs on your job portal?"
							className={`custom-accordion-item ${activeIndex === 6 ? "active" : ""
								}`}
      ...
      >
 				<div style={{ width: "50%", marginRight: "20px", display: "flex", flexDirection: "column", justifyContent: "center" }}>
          <h1 style={{ textAlign: "center" }}>How was your experience?</h1>
          <p style={{ textAlign: "center" }}>Share your feedback. Let us know about your experience!</p>
        </div>
        <div style={{ width: "50%" }}>
          <Box
            sx={{
