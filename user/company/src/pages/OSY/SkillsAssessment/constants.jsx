...
export const technicalSkillsQuestionnaires = [
  ...
  },
  {
    ...
    correctAnswer: ' D. 33% ',
    points: 2,
  }, //end of technicalquestions category
...
export const softSkillsQuestionnaires = [
  ...
  },
  {
    ...
    choices: ['A. study ', ' B. studies ', ' C. studying ', ' D. be studying '],
...
// },
// ]
// start of SelfAssessmentQuestions
export const selfAssessment = [
  {
    category: 'SelfAssessmentQuestions',
    image: ' ',
    question:
  ...
  },
  {
    category: 'SelfAssessmentQuestions',
    image: ' ',
    question: 'I recognize and reward people for doing their best.',
    choices: [
      '1 - Very Poor',
      '2 - Poor',
      '3 - Fair',
  ...
  },
  {
    category: 'SelfAssessmentQuestions',
    image: ' ',
    question: 'I select and use appropriate techniques for analysis.',
    choices: [
      '1 - Very Poor',
      '2 - Poor',
      '3 - Fair',
  ...
  },
  {
    category: 'SelfAssessmentQuestions',
    image: ' ',
    question: 'I seek ways to meet and increase customer satisfaction.',
    choices: [
      '1 - Very Poor',
      '2 - Poor',
      '3 - Fair',
  ...
  },
  {
    ...
    image: ' ',
    question:
      'I respond and adapt effectively to the changing organization, program, new direction, & responsibilities to meet the needs of the situation.',
    choices: [
      '1 - Very Poor',
      '2 - Poor',
      '3 - Fair',
  ...
  },
  {
    category: 'SelfAssessmentQuestions',
    image: ' ',
    question: 'I display good oral communication skills.',
    choices: [
      '1 - Very Poor',
      '2 - Poor',
      '3 - Fair',
  ...
  },
  {
    category: 'SelfAssessmentQuestions',
    image: ' ',
    question: 'I uphold public service ethics and accountability.',
    choices: [
      '1 - Very Poor',
      '2 - Poor',
      '3 - Fair',
  ...
  },
  {
    category: 'SelfAssessmentQuestions',
    image: ' ',
    question: 'I display confidence in other’s abilities and talents.',
    choices: [
      '1 - Very Poor',
      '2 - Poor',
      '3 - Fair',
  ...
  },
  {
    category: 'SelfAssessmentQuestions',
    image: ' ',
    question: 'I articulate the vision and mission of the institution to all.',
    choices: [
      '1 - Very Poor',
      '2 - Poor',
      '3 - Fair',
  ...
  },
  {
    category: 'SelfAssessmentQuestions',
    image: ' ',
    question: 'I set up and monitor time frames and plans.',
    choices: [
      '1 - Very Poor',
      '2 - Poor',
      '3 - Fair',
  ...
  },
  {
    category: 'SelfAssessmentQuestions',
    image: ' ',
    question: 'I secure confidential information.',
    choices: [
      '1 - Very Poor',
      '2 - Poor',
      '3 - Fair',
  ...
  },
  {
    category: 'SelfAssessmentQuestions',
    image: ' ',
    question: 'I receive constructive criticism and suggestions from others.',
    choices: [
      '1 - Very Poor',
      '2 - Poor',
      '3 - Fair',
  ...
  },
  {
    ...
    image: ' ',
    question:
      'I identify problems early on the generate alternate solutions to problems and challenges.',
    choices: [
      '1 - Very Poor',
      '2 - Poor',
      '3 - Fair',
  ...
  },
  {
    category: 'SelfAssessmentQuestions',
    image: ' ',
    question: 'I am able to deliver influential presentations.',
    choices: [
      '1 - Very Poor',
      '2 - Poor',
      '3 - Fair',
