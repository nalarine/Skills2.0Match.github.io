...
const JobDetail = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (response.success) toast.success('Job application successful.')
      else toast.error(`Job application failed. ${response.message}`)
    } catch (error) {
              ...
              >
                <div className="flex flex-col items-center justify-center min-h-screen">
                  <div className="bg-white p-10 rounded-lg shadow-md w-1/4 relative items-center">
                    ...
                    <input
                      type="file"
                      class="block mb-12 w-full text-sm text-slate-500
