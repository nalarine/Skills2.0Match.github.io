...
const UploadJob = () => {
						...
						<div className="w-full flex gap-4">
							...
							<TextInput
								...
								register={register('vacancies', {
									...
									min: {
										value: 1, // Setting minimum value to 1
										message: 'Vacancies must be at least 1', // Error message when the entered value is less than 1
									},
								})}
    ...
    <Controller
        ...
        rules={{
            ...
            maxLength: {
                value: 500, // Maximum character limit
    ...
    {errors.desc && (
        <span role="alert" className="text-xs text-red-500 mt-0.5">
            {errors.desc?.message}
						...
						<div className="flex flex-col">
                    <label className="text-gray-600 text-sm mb-1">Skills Requirements</label>
                    <Controller
                        name="requirements"
                        control={control}
                        defaultValue=""
                        rules={{
                            required: 'Skills Requirements is required!',
                            minLength: {
                                value: 50, // Minimum character limit
                                message: 'Skills Requirements must be at least 50 characters!',
                            },
                            maxLength: {
                                value: 500, // Maximum character limit
                                message: 'Skills Requirements must not exceed 500 characters!',
                            },
                        }}
                        render={({ field }) => (
                            <FroalaEditorComponent
