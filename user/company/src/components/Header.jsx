...
const Header = ({
  ...
  return (
    <div className="relative w-100 h-100" style={{
      ...
      <div className={`container mx-auto px-5 ${type ? "h-[500px]" : "h-[500px]"} flex items-center relative`}>
        ...
        <div className='w-full z-10' data-aos="fade-right" data-aos-duration="2500">
          ...
          <div className='w-full flex items-center justify-around bg-white px-2 md:px-5 py-2.5 md:py-6 shadow-2xl rounded-full' data-aos="zoom-in" data-aos-duration="2500">
            <SearchInput
