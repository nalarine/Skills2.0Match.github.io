...
export const COMPANY_DASHBOARD_SIDEBAR_LINKS = [
  ...
  },
  {
    ...
    icon: (
      <img src={profile} alt="Profile Icon" className="w-[28px] h-[28px]" />
    ),
  },
  {
    key: 'allApplicants',
...
export const COMPANY_DASHBOARD_SIDEBAR_BOTTOM_LINKS = [
  {
    ...
    path: '/CSettings',
    icon: (
      <img src={settings} alt="Settings Icon" className="w-[28px] h-[28px]" />
    ),
  },
  {
    key: 'helpCenter',
    ...
    path: '/CHelpCenter',
    icon: (
      <img src={help} alt="Help Center Icon" className="w-[28px] h-[28px]" />
    ),
  },
]
