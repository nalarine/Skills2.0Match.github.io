  ...
  return (
    <section className="bg-gray-50 dark:bg-gray-900">
      <div className="flex flex-col md:flex-row items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
        <div className="w-full md:w-1/2 p-6 bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md dark:bg-gray-800 dark:border-gray-700 sm:p-8">
        ...
        <div className="hidden md:block md:w-1/2 bg-gray-200 dark:bg-gray-700">
          {/* Add your picture template here */}
          {/* Example: <img src="your-image-url.jpg" alt="template" className="w-full h-full object-cover" /> */}
        </div>
      </div>
    </section>
  );
