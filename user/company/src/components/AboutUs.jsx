    ...
    <div className="about section p-8">
      <div className="secContainer">
        <h2
          ...
          className="title text-left text-black line-clamp-5 mb-3 mt-10 pb-8 text-3xl font-bold "
        >
        ...
        <div className="mainContent container ml-6 grid gap-4 grid-cols-3">
          ...
          >
            ...
            <h3 className="mb-3 font-bold  text-neutral-700 text-xl">
        ...
        <div
          className="videoCard container mt-14 h-80 pt-10 mb-10"
          style={{
            backgroundImage:
