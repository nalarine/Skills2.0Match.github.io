  ...
  return (
    <Menu as="div" className="relative inline-block text-left">
      <div className="flex items-center">
        <Menu.Button className="flex items-center space-x-2 w-full rounded-md bg-gradient-to-r from-blue-500 to-green-500 px-4 py-2 text-sm font-medium text-white hover:from-green-500 hover:to-blue-500 transition duration-150 ease-in-out shadow-md">
          <div className="flex flex-col items-start">
            <p className="text-sm font-semibold">
              {user?.firstName ?? user?.name}
            </p>
            <span className="text-sm text-gray-200">{userType}</span>
          </div>
          <img
            src={user.profileUrl}
            alt="user profile"
            ...
            <Menu.Item>
              {({ active }) => (
                <Link
                  ...
                  } group flex items-center w-full rounded-md p-2 text-sm transition duration-150 ease-in-out`}
                  onClick={onClick}
                >
                  <CgProfile
                    className={`${
            ...
            <Menu.Item>
              {({ active }) => (
                <button
                  ...
                  className={`${
                    active ? 'bg-green-500 text-white' : 'text-gray-900'
                  } group flex items-center w-full rounded-md px-2 py-2 text-sm transition duration-150 ease-in-out`}
                >
                  <AiOutlineLogout
                    className={`${
                      active ? 'text-white' : 'text-gray-600'
